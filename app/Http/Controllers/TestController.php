...
class TestController extends Controller{
	...
	public function axiosPost(Request $request){
		...
		$response = [];
		$response['resp0'] = 'resp0';
		$response['resp1'] = ['1_1', '1_2', '1_3'];
	...
	public function gridSystem(){
		...
		return response()->View('test/vue-js/vue-js-gridSystem', ['ctrlData'=>json_encode($ctrlData)]);
	...
	public function simpleStructure(Request $request){
		...
		if($request->method() === 'POST'){
			...
			return response(json_encode($ctrlData));
		}
		else{
